...
fn build_scores_table(results: String) -> HashMap<String, Team> {
    ...
    for r in results.lines() {
        ...
        // initial toughts...
        // scores.insert(String::from("England"), team_1_name);
        // scores.insert(team_1_name, String::from("England"));

        /*
            Thank you Jesse Verbruggen for this working solution!
            from, https://medium.com/@verbruggenjesse/rust-using-rustlings-part-10-hashmaps-83b37c59bb34
        ...
        */
        ...
        /*
            Thank you Chris Biscardi for this solution!
            From, https://www.youtube.com/watch?v=G3Vr-yswlaU
        */
